...
Public Class PhieuThuTien_DAL
    ...
    Public Function SelectAll_ListPhieuThuTienByMaPhieu(MaPhieu As Integer) As Result

        Dim query As String = "SELECT [MaPhieuThu],[PHIEUTHUTIEN].[MaKhachHang],[HoTenKhachHang],[NgayThuTien],[SoTienThu]"
        ...
        Dim MaPhieuThu_like As String = "%" + MaPhieu.ToString() + "%"
        ...
        Using conn As SqlConnection = ConnectDB.GetConnectionDB()
            Using comm As SqlCommand = conn.CreateCommand()
                ...
                With comm
                    ...
                    .Parameters.AddWithValue("@MaPhieuThu_like", MaPhieuThu_like)
